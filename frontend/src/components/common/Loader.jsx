...
export function Loader({ fullScreen = false }) {
    if (fullScreen) {
        return (
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-brand-navy/35 backdrop-blur-md">
                <div className="bg-white/80 p-8 rounded-3xl shadow-2xl border border-white/40 flex flex-col items-center gap-4 animate-fade-in">
