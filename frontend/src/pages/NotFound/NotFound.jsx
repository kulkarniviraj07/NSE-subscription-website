...
export function NotFound() {
    return (
        <div className="min-h-screen bg-brand-navy flex items-center justify-center px-4 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-md bg-brand-dark/40 backdrop-blur-md rounded-3xl border border-slate-800 p-8 sm:p-10 shadow-2xl relative z-10 text-center flex flex-col items-center">
                {/* 404 Visual Icon */}
                <div className="w-16 h-16 bg-cyan-950/40 border border-brand-cyan/30 rounded-2xl flex items-center justify-center text-brand-cyan mb-6 shadow-inner glow-cyan">
                    <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                </div>

                <span className="text-[10px] font-extrabold text-brand-cyan uppercase tracking-widest bg-cyan-950/60 px-3 py-1 rounded-full border border-cyan-800/30">
                    ERROR 404
                </span>
