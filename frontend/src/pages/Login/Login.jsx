...
export function Login() {
    ...
    return (
        <div className="min-h-screen bg-brand-navy flex items-center justify-center px-4 relative overflow-hidden font-sans">
            ...
            <div className="w-full max-w-[440px] bg-brand-dark/40 backdrop-blur-md rounded-3xl border border-brand-border p-8 sm:p-10 shadow-2xl relative z-10">
                {/* Brand Logo Header */}
                <div className="flex flex-col items-center text-center">
                    <div className="w-16 h-16 bg-brand-cyan rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-brand-cyan/20 glow-cyan">
                    ...
                    <p className="text-brand-slate text-sm mt-2 max-w-xs leading-relaxed">
                        Access premium high-frequency analytics and alerts.
                    </p>
                </div>
