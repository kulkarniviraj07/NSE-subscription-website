            ...
            <div className="w-full max-w-md bg-white rounded-[32px] shadow-xl shadow-slate-100/50 border border-slate-100 p-8 sm:p-10 relative z-10">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-[#64748B] text-[15px] mt-2 leading-relaxed">
                        ...
                        {mobileNumber && <span className="block font-bold text-[#0F172A] mt-1">{mobileNumber}</span>}
                    </p>
                </div>
                ...
                <div className="mt-8 space-y-4">
                    ...
                    <div className="flex flex-col items-center justify-center pt-2">
                        <button
                            ...
                            disabled={resending}
                            className="text-sm font-semibold text-[#2563EB] hover:text-[#1D4ED8] disabled:opacity-50 transition-colors"
                        >
                            {resending ? "Resending..." : "Resend OTP"}
                        </button>
                        
                        {resendMessage && (
                            <p className="text-xs font-semibold text-[#16A34A] mt-2 bg-green-50 px-3 py-1 rounded-full">
                                {resendMessage}
                            </p>
                        )}
                    </div>
